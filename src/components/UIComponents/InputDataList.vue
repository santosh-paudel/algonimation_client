<template>
    <div>
        <div id="aa-user-search-container" class="aa-keep-dropdown" v-on:click.stop="showDropDown">
            <div class="input-group mr-sm-2">
                ...
                <div class="input-group-append aa-keep-dropdown">
                    <div class="input-group-text bg-transparent">
                        <b-icon-chevron-down scale="1" style="cursor:pointer"></b-icon-chevron-down>
                    </div>
                </div>
            </div>
