    ...
    <div class="row justify-content-center h-100">
      <div class="col-lg-9 col-md-8 col-sm-7 h-100" id="yellow">
        <div
          ...
          style="border: 1px solid rgba(90,90,90, 0.2)"
        >
  ...
  methods: {
    ...
    insertNode: async function(inputInt) {
      ...
      if (this.bstD3Wrapper.height() > 1) {
        ...
        TreeCanvasUtil.removeElementById(ringId, this.animationTimePrimary);
      }
    ...
    deleteNode: async function(inputInt) {
      ...
      await TreeCanvasUtil.removeElementById(removalNodeSelectionRingId, 0);
